...
def write_results_to_markdown(counts, total_examples, output_file):
    """
    ...
    with open(output_file, 'w') as f:
        f.write("# Permutation Key Distribution Analysis\n\n")
        f.write(f"**Dataset Path:** `/mnt/ephemeral/deduplicated/cdr/database_mlm`\n\n")
...
def main():
    ...
    parquet_dir = "/mnt/ephemeral/deduplicated/cdr/database_mlm"
    output_file = project_root / "outputs" / "permutation_key_counts.md"
    
    print("Starting permutation_key counting...")
    ...
    write_results_to_markdown(counts, total_examples, output_file)
