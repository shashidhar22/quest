...
- 6 order_keys · 6 parquet files · 16.0M (16,797,830 bytes) · 293,448 rows (matches expected)
...
- 6 order_keys · 6 parquet files · 16.0M (16,754,379 bytes) · 293,448 rows (matches expected) · enriched row count == deduped row count
