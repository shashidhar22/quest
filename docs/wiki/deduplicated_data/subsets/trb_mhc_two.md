...
- 2 order_keys · 2 parquet files · 315.5K (323,035 bytes) · 8,312 rows (matches expected)
...
- 2 order_keys · 2 parquet files · 366.8K (375,625 bytes) · 8,312 rows (matches expected) · enriched row count == deduped row count
