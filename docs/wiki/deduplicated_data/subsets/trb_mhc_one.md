...
- 2 order_keys · 2 parquet files · 6.9M (7,222,578 bytes) · 202,560 rows (matches expected)
...
- 2 order_keys · 2 parquet files · 7.5M (7,828,988 bytes) · 202,560 rows (matches expected) · enriched row count == deduped row count
