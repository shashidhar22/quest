...
- 6 order_keys · 6 parquet files · 396.1K (405,626 bytes) · 8,880 rows (matches expected)
...
- 6 order_keys · 6 parquet files · 481.0K (492,588 bytes) · 8,880 rows (matches expected) · enriched row count == deduped row count
