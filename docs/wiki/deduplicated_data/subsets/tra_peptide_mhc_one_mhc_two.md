...
- 24 order_keys · 24 parquet files · 1.2M (1,255,967 bytes) · 22,512 rows (matches expected)
...
- 24 order_keys · 24 parquet files · 1.5M (1,549,061 bytes) · 22,512 rows (matches expected) · enriched row count == deduped row count
