...
- 2 order_keys · 2 parquet files · 4.2M (4,397,968 bytes) · 136,834 rows (matches expected)
...
- 2 order_keys · 2 parquet files · 4.6M (4,775,463 bytes) · 136,834 rows (matches expected) · enriched row count == deduped row count
