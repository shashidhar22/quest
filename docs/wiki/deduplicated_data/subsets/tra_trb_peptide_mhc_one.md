...
- 24 order_keys · 24 parquet files · 75.4M (79,064,839 bytes) · 1,369,896 rows (matches expected)
...
- 24 order_keys · 24 parquet files · 81.7M (85,648,091 bytes) · 1,369,896 rows (matches expected) · enriched row count == deduped row count
