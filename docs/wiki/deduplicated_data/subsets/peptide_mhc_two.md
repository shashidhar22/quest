...
- 2 order_keys · 18 parquet files · 58.4M (61,208,635 bytes) · 2,032,504 rows (matches expected)
...
- 2 order_keys · 18 parquet files · 64.2M (67,308,480 bytes) · 2,032,504 rows (matches expected) · enriched row count == deduped row count
