...
- 6 order_keys · 6 parquet files · 664.6K (680,571 bytes) · 18,294 rows (matches expected)
...
- 6 order_keys · 6 parquet files · 721.0K (738,315 bytes) · 18,294 rows (matches expected) · enriched row count == deduped row count
