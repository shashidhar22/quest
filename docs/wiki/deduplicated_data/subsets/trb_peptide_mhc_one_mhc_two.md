...
- 24 order_keys · 24 parquet files · 1.3M (1,384,221 bytes) · 25,536 rows (matches expected)
...
- 24 order_keys · 24 parquet files · 1.6M (1,688,398 bytes) · 25,536 rows (matches expected) · enriched row count == deduped row count
