...
- 2 order_keys · 2 parquet files · 176.0K (180,227 bytes) · 5,216 rows (matches expected)
...
- 2 order_keys · 2 parquet files · 208.1K (213,105 bytes) · 5,216 rows (matches expected) · enriched row count == deduped row count
