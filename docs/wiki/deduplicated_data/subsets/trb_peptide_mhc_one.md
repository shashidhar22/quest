...
- 6 order_keys · 6 parquet files · 24.2M (25,327,271 bytes) · 680,868 rows (matches expected)
...
- 6 order_keys · 6 parquet files · 27.2M (28,548,874 bytes) · 680,868 rows (matches expected) · enriched row count == deduped row count
