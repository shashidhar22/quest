...
- 2 order_keys · 2 parquet files · 22.4K (22,904 bytes) · 266 rows (matches expected)
...
- 2 order_keys · 2 parquet files · 36.4K (37,223 bytes) · 266 rows (matches expected) · enriched row count == deduped row count
