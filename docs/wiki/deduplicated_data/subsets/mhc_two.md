...
- 1 order_keys · 1 parquet files · 135.1K (138,334 bytes) · 5,721 rows (matches expected)
...
- 1 order_keys · 1 parquet files · 175.9K (180,116 bytes) · 5,721 rows (matches expected) · enriched row count == deduped row count
