...
- 6 order_keys · 6 parquet files · 14.6M (15,340,189 bytes) · 460,824 rows (matches expected)
...
- 6 order_keys · 6 parquet files · 15.9M (16,658,210 bytes) · 460,824 rows (matches expected) · enriched row count == deduped row count
