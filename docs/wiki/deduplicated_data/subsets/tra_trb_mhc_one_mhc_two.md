...
- 24 order_keys · 24 parquet files · 1.7M (1,775,351 bytes) · 20,136 rows (matches expected)
...
- 24 order_keys · 24 parquet files · 2.0M (2,078,983 bytes) · 20,136 rows (matches expected) · enriched row count == deduped row count
