...
- 6 order_keys · 6 parquet files · 347.2K (355,493 bytes) · 8,364 rows (matches expected)
...
- 6 order_keys · 6 parquet files · 429.5K (439,799 bytes) · 8,364 rows (matches expected) · enriched row count == deduped row count
