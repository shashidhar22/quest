...
- 2 order_keys · 2 parquet files · 4.7M (4,894,110 bytes) · 166,376 rows (matches expected)
...
- 2 order_keys · 2 parquet files · 4.7M (4,879,730 bytes) · 166,376 rows (matches expected) · enriched row count == deduped row count
