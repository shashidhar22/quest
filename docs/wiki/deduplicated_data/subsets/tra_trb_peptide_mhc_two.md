...
- 24 order_keys · 24 parquet files · 4.3M (4,536,055 bytes) · 83,832 rows (matches expected)
...
- 24 order_keys · 24 parquet files · 4.4M (4,665,939 bytes) · 83,832 rows (matches expected) · enriched row count == deduped row count
