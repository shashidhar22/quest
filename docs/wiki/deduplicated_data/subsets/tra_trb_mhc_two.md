...
- 6 order_keys · 6 parquet files · 909.7K (931,528 bytes) · 14,136 rows (matches expected)
...
- 6 order_keys · 6 parquet files · 1.0M (1,065,301 bytes) · 14,136 rows (matches expected) · enriched row count == deduped row count
